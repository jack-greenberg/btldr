...
//!
//! @brief This file contains all prototypes and macros of CAN macrocell
//!        ffor AT90CAN128/64/32 and ATmega16M1/32M1/32C1/64M1/64C1.
//!
...
#elif defined(__ATmega16M1__) || defined(__ATmega32M1__) || defined(__ATmega32C1__) || defined(__ATmega64M1__) || defined(__ATmega64C1__)
...
#   define NB_MOB          6
#   define Can_clear_mob()        { U8  volatile *__i_; for (__i_=&CANSTMOB; __i_<&CANSTMPL; __i_++) { *__i_=0x00 ;}}
#else
...
#define SJW_MAX     4
    // ----------
// "#define NB_MOB" already defined above (following the device) 
...
//#define Can_clear_mob()        { CANSTMOB=0x00; CANCDMOB=0x00; \
...
//!         ==1: start the evaluation with CANBTx registers contents
//!
